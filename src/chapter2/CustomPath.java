...
class PathPanel extends JPanel {
  ...
  public void paintComponent(Graphics g) {
    ...
    // Det jeg har gjort er � lage en Shape i stedenfor som jeg kaller pathshape.
    // For hver gang path endres settes pathshape p� nytt. 
    // Tilslutt har jeg bare endret i fra den gamle variabelen path til den nye pathshape p� alle plasser den skal tegnes.
